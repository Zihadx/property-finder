...
const HowItWorks=() => {
  ...
  return (
    <section className="relative overflow-hidden bg-[#f6f5f1] text-stone-950">
      {/* Atmospheric light */}
      <div
        aria-hidden="true"
      ...
      <div className="relative mx-auto max-w-[1500px] px-6 py-20 sm:px-8 md:py-28 lg:px-12 xl:px-16">
        {/* ───────────────── Header ───────────────── */}
