...
import {
  projectAreaOptions,
  projectBudgetPresets,
  projectHandoverOptions,
  projectStatuses,
  projectTypes,
} from "./project-filter-options";
...
export function ProjectFiltersForm({ onApply }: { onApply?: () => void }) {
  ...
  const [handover, setHandover] = React.useState(searchParams.get("handover") ?? "");
  ...
  return (
    <div className="flex flex-col gap-6 py-6">
      ...
      <Field label="Expected handover">
        <Select value={handover} onChange={(e) => setHandover(e.target.value)} className={fieldClass}>
