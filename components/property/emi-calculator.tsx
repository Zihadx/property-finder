...
interface EmiCalculatorProps {
  ...
  /** Copy overrides — pass different values on project pages to reuse this
   *  same component without changing behavior. All are optional and fall
   *  back to the original property-page wording.
   *
   *  If a page swaps which listing/unit this calculator represents (e.g. a
   *  project page letting the user pick between unit types), pass a
   *  different `key` (such as `key={unit.id}`) from the parent so React
   *  remounts the component and resets price, down payment, rate, and
   *  years together — don't try to sync `defaultPrice` into state here. */
  eyebrow?: string;
  heading?: string;
...
export function EmiCalculator({
  ...
  salesPhone,
  eyebrow = "Financing",
  heading = "Shape the numbers.",
  priceFieldLabel = "Property price",
  helperText = "Adjust the property price, down payment, interest rate and tenure to create an indicative financing scenario.",
  ctaLabel = "Speak with an advisor",
  disclaimer = "Estimate only. Actual rates, fees and eligibility vary by lender.",
}: EmiCalculatorProps) {
