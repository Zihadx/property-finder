 ...
 */
export function FeaturedPropertyCard({ property, agent }: { property: Property; agent?: Agent }) {
  return (
    <article className="group relative overflow-hidden rounded-[var(--radius-lg)] border border-border bg-surface">
      <Link href={`/properties/${property.slug}`} className="block">
        <div className="relative aspect-[4/5] w-full overflow-hidden bg-surface-muted sm:aspect-[16/9] lg:aspect-[21/9]">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[rgba(28,27,25,0.88)] via-[rgba(28,27,25,0.2)] to-transparent" />
          ...
          <div className="absolute inset-x-5 bottom-5 flex flex-wrap items-end justify-between gap-4 sm:inset-x-8 sm:bottom-8">
            <div className="max-w-xl">
              <p className="ledger-label text-primary-foreground/70">Signature Listing</p>
              ...
              <PropertyFacts property={property} className="mt-4 text-primary-foreground/90" />
            </div>
