      ...
      <div className="flex flex-wrap items-center justify-between gap-5">
        ...
        <p className="text-sm text-foreground">
          ...
          <span className="text-muted-foreground">
            {resultCount === 1 ? "property found" : "properties found"}
          </span>
        </p>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <Button
            variant="outline"
            size="sm"
            className="h-10 rounded-none border-border px-4 text-xs font-medium lg:hidden"
          ...
          <Select
            ...
            className="h-10 w-40 rounded-none border-border bg-transparent text-sm text-foreground"
